...
const defaultDb: DbSchema = {
  ...
  councils: {
    ...
    visionText: "إن رؤيتنا تتبلور في قيادة العمل الاجتماعي الأهلي بمنطقة عسير لتكون بلدة المسقي نموذجاً حياً للمشاريع التربوية والتطوعية المتميزة.",
    missionText: "نهدف إلى تقديم مجموعة شاملة من الخدمات والمبادرات التنموية لتمكين الطاقات البشرية، ودعم المواهب، وتيسير قنوات التدريب، بما يدعم رؤية المملكة 2030 في رفع نسب جودة الحياة ونشر الوعي الثقافي والتنموي.",
    valuesText: "المواطنة الفاعلة، العمل التطوعي، الشفافية والحوكمة، التميز المجتمعي، والالتزام بخدمة أهالي قرية المسقي وتراثها العريق.",
    current: [
      {
        id: "c1",
